...
class Category(models.Model):
    ...
    meta_description=models.TextField(max_length=1050,null=False,blank=False)
...
class Product(models.Model):
    ...
    small_description=models.CharField(max_length=1500,null=False,blank=False)
    ...
    meta_title=models.CharField(max_length=50,null=False,blank=False)
    meta_keyword=models.CharField(max_length=50,null=False,blank=False)
    meta_description=models.TextField(max_length=1500,null=False,blank=False)
    created_at=models.DateTimeField(auto_now_add=True)
